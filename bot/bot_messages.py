...
HELPRULES = "Правила игры: пароль состоит из четырёх цифр, при введении пароля будет показываться: сколько цифр Вы угадали,сколько из них стоят на правельных позициях." \
